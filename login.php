...
<head>
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0;font-family:'Inter',sans-serif;}
    ...
    .logo-icon{width:72px;height:72px;background:linear-gradient(135deg,#1d4ed8,#4a9eff);border-radius:22px;display:flex;align-items:center;justify-content:center;margin:0 auto 16px;box-shadow:0 0 40px rgba(74,158,255,.4);}
    h1{font-size:28px;font-weight:900;letter-spacing:-1px;text-align:center;}
    h1 span{color:#4a9eff;}
    .sub{color:#3a5470;font-size:14px;text-align:center;margin-top:4px;}
    ...
    .btn-main{width:100%;margin-top:8px;background:linear-gradient(135deg,#1d4ed8,#4a9eff);color:#fff;border:none;border-radius:100px;padding:14px;font-size:15px;font-weight:800;cursor:pointer;letter-spacing:.3px;transition:opacity .15s,transform .1s;box-shadow:0 4px 20px rgba(74,158,255,.3);}
    ...
    .link-row{text-align:center;color:#3a5470;font-size:13px;margin-top:20px;}
...
<div class="card">
  <div class="logo">
    <div class="logo-icon">
      <svg width="36" height="36" fill="none" stroke="#fff" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 10.5l4.72-4.72a.75.75 0 011.28.53v11.38a.75.75 0 01-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25h-9A2.25 2.25 0 002.25 7.5v9a2.25 2.25 0 002.25 2.25z"/></svg>
    </div>
    <h1><span>Kai</span>VC</h1>
    <p class="sub">Voice & Chat Platform</p>
  </div>
  <?php if ($error): ?>
  ...
  <form method="POST" id="login-form">
    <div class="field">
      <label>Email</label>
      <input id="email-in" type="email" name="email" placeholder="kamu@email.com" required value="<?= htmlspecialchars($_POST['email']??'') ?>">
    </div>
    <div class="field">
      <label>Password</label>
      <input id="pass-in" type="password" name="password" placeholder="••••••••" required>
    </div>
    <button id="login-btn" class="btn-main" type="submit">Masuk</button>
  </form>
  <div class="link-row">Belum punya akun? <a id="to-reg" href="register.php">Daftar sekarang</a></div>
</div>
</body>
</html>
